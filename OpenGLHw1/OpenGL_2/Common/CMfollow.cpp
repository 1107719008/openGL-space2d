...
{//missle front bullet --follow boss
	...
	_Points[2] = vec4(0.0f, 1.0f, 0.0f, 1.0f);

	_Points[3] = vec4(0.0f, -1.0f, 0.0f, 1.0f);
	_Points[4] = vec4(-0.5f, -0.5f, 0.0f, 1.0f);
	_Points[5] = vec4(0.0f, 1.0f, 0.0f, 1.0f);
...
void CMfollow::CreateBufferObject()
{
...
void CMfollow::setShader(mat4 &mxView, mat4 &mxProjection, GLuint uiShaderHandle)
{
...
void CMfollow::setViewMatrix(mat4 &mat)
{
	_mxView = mat;
	_bUpdateMV = true;
}

void CMfollow::setProjectionMatrix(mat4 &mat)
{
	_mxProjection = mat;
	_bUpdateProj = true;
}

void CMfollow::setTRSMatrix(mat4 &mat)
{
	_mxTRS = mat;
	_bUpdateMV = true;
}
...
void CMfollow::setColor(GLfloat vColor[4])
{
...
void CMfollow::setVtxColors(GLfloat vLFColor[], GLfloat vLRColor[], GLfloat vTRColor[], GLfloat vTLColor[])
{
...
void CMfollow::Disable(float dt) {//not used
	...
	moveT = Translate(followX, followY, 0);
